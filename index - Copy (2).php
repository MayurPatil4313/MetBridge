...
<div class="section-bg" style="background-image: url(img/charity/charity1.jpg);"></div>
...
<h1 style="color:black;">Online Charity</h1>
<p class="lead" style="color:black;">With your support, we can help more children</p>
</div>
</div>
</div>
</div>
...
<div class="section-bg" style="background-image: url(img/charity/charity2.jpg);"></div>
...
<div class="home-content">
<h1 style="color:black;">Online Charity</h1>
<p class="lead" style="color:black;">THIS NEW YEAR, COME TOGETHER TO SUPPORT HEALTH, EDUCATION,
...
<h2 class="title">Welcome to MetBridge</h2>
<p class="sub-title">
"Empowering Change Together: Join our compassionate community in making a positive impact. Your support fuels our mission to create a better world through acts of kindness and generosity."</p>
</div>
<div class="about-content">
<p>"Empowering Change Together: Join our compassionate community in making a positive impact. Together, we transform lives and uplift those in need, with transparency and accountability in our actions. Stay informed and inspired by subscribing to our newsletter and following us on social media. Thank you for being the driving force behind our mission to build a brighter, more compassionate world."..</p>
...
<h2 class="title">MetBridge Charity</h2>
</div>
</div>
