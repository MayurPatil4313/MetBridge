...
<a class="logo" href="index.php"><img src="img/Medbridge2.png" alt="logo"></a>
</div>
...
<li class="has-dropdown"><a href="#">Orphans</a>
	<ul class="dropdown">
		<li><a href="member.php" >Add Orphans</a></li>
		<li><a href="viewmember.php" >View Orphans</a></li>
		<li><a href="membertype.php" >Add Orphans type</a></li>
		<li><a href="viewmembertype.php" >View Orphans type</a></li>
	</ul>
</li>
...
<li><a href="fundraiser.php">Fund Raiser</a></li>
<li><a href="displaymembers.php">Orphans</a></li>
<li><a href="gallery.php">Gallery</a></li>
